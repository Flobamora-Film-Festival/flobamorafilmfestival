...
const Footer = () => {
  ...
  return (
    <motion.footer
      ...
      className="bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100 border-t border-gray-300 dark:border-gray-700"
    >
      <footer className="bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100 border-t border-gray-300 dark:border-gray-700">
        <div className="max-w-7xl mx-auto px-6 py-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 text-center md:text-left">
          ...
          <div>
            ...
            <p className="flex items-center justify-center md:justify-start gap-2">
              ...
              <a
                href="https://maps.app.goo.gl/r4KNtwBaKzZnoJvP6"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-red-600 transition"
              >
                Jl. Kejora No.4,{" "}
                {isIndonesian ? "Kota Kupang, NTT." : "Kupang City, NTT."}
              </a>
            </p>
            ...
            <div className="flex justify-center md:justify-start gap-4 mt-4 text-xl">
              <a
                href="https://www.facebook.com/profile.php?id=61551863112603"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-red-600 transition"
                aria-label="Facebook"
              ...
              <a
                href="https://www.instagram.com/flobamorafilmfestival/"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-red-600 transition"
              ...
              <a
                href="https://www.youtube.com/channel/UC9zLYkF5-VuU2vKdrutK-0w"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-red-600 transition"
                aria-label="Youtube"
              ...
              <a
                href="https://www.tiktok.com/@flobamorafilmfestival"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-red-600 transition"
                aria-label="Tiktok"
          ...
          <div>
            <h4 className="font-bold mb-3">
              {isIndonesian ? "Navigasi" : "Navigation"}
            </h4>
        ...
        <div className="text-center w-full pt-6 border-t border-gray-400">
          <p>
            © 2025 Flobamora Film Festival.{" "}
            {isIndonesian ? "Hak cipta dilindungi." : "All rights reserved."}
          </p>
        </div>
      </footer>
    </motion.footer>
