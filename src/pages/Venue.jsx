...
const Venue = () => {
  ...
  const content = {
    ID: {
      ...
      addressLabel: "Alamat:",
      address:
        "Jl. Kejora Oepoi No.1, Oebufu, Kec. Oebobo, Kota Kupang, Nusa Tenggara Timur 85142",
    },
    EN: {
      title: "Venue Map",
      ...
      address:
        "Jl. Kejora Oepoi No.1, Oebufu, Oebobo District, Kupang City, East Nusa Tenggara 85142, Indonesia",
    },
  };
  ...
  return (
    <div
      className={`min-h-screen py-10 px-5 lg:px-20 transition-all duration-300 ${
        theme === "dark"
