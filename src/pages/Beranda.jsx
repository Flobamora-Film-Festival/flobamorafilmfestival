...
const text = {
  ID: {
    ...
    festivalOverview:
      "Flobamora Film Festival telah menjangkau lebih dari 2.000 penonton...",
    learnMore: "Pelajari Selengkapnya",
    competition: "Kompetisi Film",
    competitionDesc:
      "Ajang bagi sineas muda untuk menunjukkan karya terbaik mereka.",
    workshop: "Workshop & Diskusi",
    workshopDesc:
      "Pelatihan intensif dan diskusi bersama praktisi industri film.",
    ...
    audience:
      "Lebih dari 2.000 penonton dari berbagai usia menghadiri festival.",
    filmPractitioners:
      "Bekerja sama dengan lebih dari 100 praktisi film lokal, nasional, dan internasional.",
    title: "Sponsor Kami",
    ...
    joinDesc:
      "Mari menjadi bagian dari perjalanan sinematik Flobamora Film Festival!",
  ...
  EN: {
    ...
    festivalName: "Flobamora Film Festival",
    description:
      "Flobamora Film Festival is the first national-scale short film festival in East Nusa Tenggara (NTT). We provide a space for filmmakers, especially young directors, to showcase their best works.",
    aboutFestival:
    ...
    festivalOverview:
      "Flobamora Film Festival has reached over 2,000 audiences...",
    learnMore: "Learn More",
    competition: "Film Competition",
    competitionDesc:
      "A platform for young filmmakers to showcase their best work.",
    workshop: "Workshops & Discussions",
    workshopDesc:
      "Intensive training and discussions with film industry professionals.",
    ...
    filmPractitioners:
      "Collaborating with over 100 local, national, and international film practitioners.",
    title: "Our Sponsors",
    ...
    joinDesc:
      "Be part of the cinematic journey at the Flobamora Film Festival!",
...
const Beranda = () => {
  ...
  const currentSponsors =
    Object.values(
      import.meta.glob("../assets/sponsor/current/*.png", { eager: true })
    )?.map((mod) => mod.default) ?? [];
  ...
  return (
        ...
        <div className="w-full flex justify-center">
          <div className="relative w-full max-w-[900px] flex items-center justify-center">
            ...
            <motion.img
              ...
              alt={
                language === "ID"
                  ? "Artwork Flobamora Film Festival (ID)"
                  : "Flobamora Film Festival Artwork (EN)"
              }
    ...
    dark:border-transparent focus:outline-none focus:ring-2 focus:ring-[#b820e6]"
      ...
      <motion.section
        id="tentang-festival"
        className="w-full px-6 sm:px-12 lg:px-[8%] py-16 sm:py-20 lg:py-24 bg-gradient-to-b from-[#f8f9fa] to-[#e9ecef] dark:from-[#111827] dark:to-[#1f2937]"
      >
        <motion.div
          className="flex flex-col lg:flex-row items-center lg:justify-center gap-6"
          initial={{ opacity: 0, y: 50 }}
        ...
        >
          ...
          <motion.div className="w-full flex justify-center lg:w-1/2 lg:justify-center">
            <img
              src={isDarkMode ? userImageDark : userImageLight}
              alt="Festival image"
              className="w-44 sm:w-56 md:w-64 lg:w-80 max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg rounded-2xl shadow-lg object-cover"
            />
          </motion.div>
          ...
          <div className="w-full lg:w-1/2 flex flex-col justify-center text-center lg:text-left">
            {/* Judul */}
            <h4 className="text-lg sm:text-xl font-Outfit font-bold text-gray-800 dark:text-gray-200 uppercase tracking-wide">
              {selectedText.aboutHeader}
            </h4>

            {/* Deskripsi */}
            <p className="mt-3 max-w-2xl font-Outfit text-gray-700 dark:text-gray-300 leading-relaxed text-justify">
              {selectedText.aboutFestival}
            </p>
      ...
      >
        <div className="text-center">
          <h4 className="text-lg sm:text-xl font-Outfit font-bold text-gray-800 dark:text-gray-200 uppercase tracking-wide">
            {language === "ID" ? "Festival Sebelumnya" : "Previous Festivals"}
          </h4>
          <p className="mt-3 max-w-3xl mx-auto text-gray-700 dark:text-gray-300 leading-relaxed">
            {language === "ID"
              ? "Berikut adalah highlights dari Flobamora Film Festival tahun-tahun sebelumnya."
              : "Here are some highlights from previous editions of the Flobamora Film Festival."}
          </p>
        </div>
        ...
        <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {previousFestivals.map((festival, index) => (
            <motion.div
              key={index}
              className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg hover:shadow-xl transition-all flex flex-col"
            ...
            >
              ...
              <h5 className="text-lg font-semibold text-gray-800 dark:text-gray-200">
                {`Flobamora Film Festival ${festival.year}`}
              </h5>
              <p className="text-sm lg:text-xs font-normal text-gray-600 dark:text-gray-400 leading-tight mt-2">
                {festival.desc[language]}
              </p>

              {/* Teks "Baca Selengkapnya" sebagai Link */}
              <div className="mt-4">
                <a
                  href={`/tentang#${festival.id}`}
      ...
      <section className="relative py-20 text-center bg-gray-50 dark:bg-gray-900 flex flex-col items-center">
        {/* Sponsor Kami */}
        <div className="text-center">
          <h4 className="text-lg sm:text-xl font-Outfit font-bold text-gray-800 dark:text-gray-200 uppercase tracking-wide mb-4">
            {language === "ID" ? "Sponsor Kami" : "Our Sponsors"}
          </h4>
          <p className="mt-3 max-w-3xl mx-auto text-gray-700 dark:text-gray-300 leading-relaxed text-lg">
            {language === "ID"
              ? "Kami berterima kasih kepada para sponsor yang telah mendukung Flobamora Film Festival."
              : "We are grateful to the sponsors who have supported the Flobamora Film Festival."}
          </p>
        </div>
              ...
              currentSponsors.map((logo, index) => (
                ...
                >
                  <img
                    src={logo}
                    alt={`Sponsor ${index + 1}`}
                    className="w-32 h-auto object-contain shadow-lg hover:shadow-2xl transition-shadow duration-300"
                  />
                </div>
              ))
            ) : (
      ...
      >
        ...
        <p className="mt-4 text-lg max-w-2xl mx-auto">
          {selectedText.joinDesc}
        </p>
        <a
          href="/submit-film"
          className="mt-6 inline-block px-8 py-3 bg-red-600 rounded-full text-white text-lg hover:bg-red-700"
        >
