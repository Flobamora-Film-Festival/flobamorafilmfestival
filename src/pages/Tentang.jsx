...
const Tentang = () => {
  ...
  return (
    <div className="px-10 sm:px-6 md:px-10 lg:px-16 xl:px-24 py-10 max-w-7xl mx-auto space-y-12">
      <Helmet>
        <title>
          {language === "ID" ? "Tentang" : "About"} | Flobamora Film Festival
        </title>
        <meta
          name="description"
          content="Flobamora Film Festival adalah festival film pendek nasional di NTT."
        />
      </Helmet>
      ...
      <h1 className="text-2xl sm:text-3xl font-bold">
        {language === "ID"
          ...
          : "About Flobamora Film Festival"}
      </h1>

      <section className="space-y-2">
        <h2 className="text-lg sm:text-xl font-semibold">
          {language === "ID"
            ? "Apa Itu Flobamora Film Festival?"
            : "What is Flobamora Film Festival?"}
        </h2>
      ...
      <section className="space-y-2">
        <h2 className="text-lg sm:text-xl font-semibold">
          {language === "ID" ? "Edisi Terbaru" : "Upcoming Edition"}
        </h2>
        <p>
          <strong>
            🗓️ 5–9 {language === "ID" ? "Agustus" : "August"} 2025
          </strong>
          <br />
        ...
        <p className="leading-relaxed">
          <strong>
            {language === "ID" ? "Tema 2025: Kalunga" : "Theme 2025: Kalunga"}
          </strong>
          <br />
          {language === "ID"
      ...
      <section className="space-y-2">
        <h2 className="text-lg sm:text-xl font-semibold">
          {language === "ID" ? "Visi Festival" : "Festival Vision"}
        </h2>
        <ul className="list-disc list-inside space-y-1 leading-relaxed">
          <li>
            {language === "ID"
              ? "Mendorong budaya menonton dan apresiasi film yang inklusif."
              : "Foster a culture of watching and appreciating films inclusively."}
          </li>
          <li>
            {language === "ID"
              ? "Mengembangkan penonton yang kritis dan terbuka terhadap keragaman sinema."
              : "Build a critical audience open to diverse cinematic expressions."}
          </li>
          <li>
            {language === "ID"
              ? "Mendorong kreativitas pembuat film muda di wilayah Timur Indonesia."
              : "Support young filmmakers from Eastern Indonesia to grow and flourish."}
          </li>
          <li>
            {language === "ID"
              ? "Menjadikan festival ini sebagai ruang bertemu dan berbagi lintas komunitas film."
              : "Create a collaborative space for film communities to meet and connect."}
          </li>
        </ul>
      </section>
      ...
      <section className="space-y-2">
        <h2 className="text-lg sm:text-xl font-semibold">
          {language === "ID" ? "Sejarah Festival" : "Festival Timeline"}
        </h2>
          ...
          <table className="table-auto w-full border text-sm sm:text-base">
            <thead>
              <tr className="bg-gray-200 dark:bg-gray-700">
                ...
                <th className="border px-2 py-1">
                  {language === "ID" ? "Judul Festival" : "Festival Title"}
                </th>
                <th className="border px-2 py-1">
                  {language === "ID" ? "Sorotan" : "Highlights"}
                </th>
              </tr>
            </thead>
            <tbody>
              {[
                {
                  ...
                  highlight:
                    language === "ID"
                      ? "Tema Sokong. Program pemutaran perdana hasil kolaborasi komunitas film NTT."
                      : "Theme: Sokong. Premiere screenings initiated by local film communities in NTT.",
                },
                {
                  year: "2022",
                  ...
                  highlight:
                    language === "ID"
                      ? "Tema Harmoni. Fokus pada kolaborasi dan pemutaran lintas desa & sekolah."
                      : "Theme: Harmony. Collaborative screenings across villages and schools.",
                },
                {
                  year: "2023",
                  ...
                  highlight:
                    language === "ID"
                      ? "Tema Konektivitas. Resmi memakai nama FFF, menampilkan kompetisi dan layar non-kompetisi."
                      : "Theme: Connectivity. First edition under official name, featuring competitions.",
                },
                {
                  year: "2024",
                  ...
                  highlight:
                    language === "ID"
                      ? "Tema Gemohing. Hadir dengan lebih dari 50 film dan 1500+ penonton."
                      : "Theme: Gemohing. Showcased 50+ short films and welcomed 1500+ attendees.",
                },
                {
                  year: "2025",
                  ...
                  highlight:
                    language === "ID"
                      ? "Tema Kalunga. Ekspansi program ke berbagai kota dan komunitas."
                      : "Theme: Kalunga. Program expansion to various cities and communities.",
                },
              ].map((item) => (
                <tr key={item.year}>
                  ...
                  <td className="border px-2 py-1 align-top max-w-md">
                    <img
                      src={item.img}
                      alt={item.title}
                      className="w-full max-w-[300px] sm:max-w-sm mb-2 rounded-lg shadow-md"
                    />
                    {item.highlight}
                  </td>
                </tr>
      ...
      <section className="space-y-2">
        <h2 className="text-lg sm:text-xl font-semibold">
          {language === "ID" ? "Penggagas & Pendukung" : "Founder & Supporters"}
        </h2>
        <p className="leading-relaxed">
          {language === "ID"
      ...
      <section className="space-y-2">
        <h2 className="text-lg sm:text-xl font-semibold mb-2">
          {language === "ID" ? "Lokasi Festival" : "Festival Location"}
        </h2>
